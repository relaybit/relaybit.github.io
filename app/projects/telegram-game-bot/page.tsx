...
export const metadata: Metadata = {
  ...
  openGraph: { url: '/projects/telegram-game-bot/', type: 'article', images: ['/telegram-game-bot-cover.jpg'] },
  twitter: { card: 'summary_large_image', images: ['/telegram-game-bot-cover.jpg'] },
};
