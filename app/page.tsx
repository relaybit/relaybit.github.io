...
export default function Home() {
  ...
  return <main>
    ...
    <section className="contact shell" id="contact"><div className="contact-orb">↗</div><span>Связаться</span><h2>Давайте уберём<br/><em>ручную работу.</em></h2><p>Опишите, что приходится повторять каждый день. Я бесплатно скажу, можно ли это автоматизировать, и назову срок.</p><div className="contact-links"><a href="https://t.me/leonid_northline" target="_blank" rel="noreferrer"><small>Telegram</small><strong>@leonid_northline</strong><b>Написать →</b></a><div><small>Email</small><strong>Рабочая почта готовится</strong><b>Скоро</b></div></div></section>
    <SiteFooter />
  </main>;
}
