...
export default function Home() {
  ...
  return <main>
    ...
    <section className="contact shell" id="contact"><div className="contact-orb">↗</div><span>Связаться</span><h2>Давайте уберём<br/><em>ручную работу.</em></h2><p>Опишите, что приходится повторять каждый день. Я бесплатно скажу, можно ли это автоматизировать, и назову срок.</p><div className="contact-links"><a href="https://t.me/leonid_relaybit" target="_blank" rel="noreferrer"><small>Telegram</small><strong>@leonid_relaybit</strong><b>Написать →</b></a><a href="mailto:relaybit@gmail.com"><small>Email</small><strong>relaybit@gmail.com</strong><b>Написать →</b></a></div></section>
    <SiteFooter />
  </main>;
}
